// ai-regulation-tracker — main entry point
...
export function getStatus(): Record<string, unknown> {
  return { service: "ai-regulation-tracker", version: VERSION, ready: true };
}

if (process.argv[1] && import.meta.url === `file://${process.argv[1]}`) {
  console.log(`ai-regulation-tracker v${VERSION}`);
